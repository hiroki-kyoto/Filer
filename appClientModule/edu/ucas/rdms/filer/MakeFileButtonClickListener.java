...
public class MakeFileButtonClickListener implements ActionListener {

	@Override
	public void actionPerformed(ActionEvent e) {
		// TODO Auto-generated method stub
		WebButton btn_make_file = (WebButton) e.getSource();
		
		btn_make_file.getParent().setVisible(false);
		
		WebPanel panel_make_file = (WebPanel) btn_make_file.getParent().getParent().getComponent(2);
		panel_make_file.setVisible(true);
		
		WebTable table = (WebTable) panel_make_file.getComponent(2);
		...
		try {
			String response = client.sendGet("http://124.16.70.51/rdms/client_solution_query.php?page=1");
